...
import 'package:quran_app/controller/home_page_ctrl.dart';
                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 70),
                      const CustomButton(textButton: "تلاوة"),
                      const CustomButton(textButton: "سماع"),
                    ],
                  ),
                ),
              ],
